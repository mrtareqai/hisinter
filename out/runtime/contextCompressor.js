...
class ContextCompressor {
    compress(messages, maxMessages, maxChars) {
        const selected = [];
        let total = 0;
    ...
    scopedFileContext(filePath, content, maxChars) {
     ...
     */
    scopedTaskContext(messages, scope, maxMessages, maxChars) {
