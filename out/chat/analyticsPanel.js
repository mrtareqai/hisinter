...
exports.analyticsPanel = exports.AnalyticsPanel = void 0;
const performanceMonitor_1 = require("../runtime/performanceMonitor");
const cacheManager_1 = require("../runtime/cacheManager");
const contextOptimizer_1 = require("../runtime/contextOptimizer");
const workspaceIntelligence_1 = require("../agent/workspaceIntelligence");
class AnalyticsPanel {
    generateDashboard() {
        const metrics = performanceMonitor_1.globalMonitor.getMetrics();
        const cacheStats = cacheManager_1.globalCache.getStats();
        const workspaceStats = workspaceIntelligence_1.globalWorkspaceIntelligence.getFilesSummary();
        const contextTrends = contextOptimizer_1.globalContextOptimizer.getContextTrends();
        const alerts = performanceMonitor_1.globalMonitor.getAlerts();
        const html = `
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <div class="optimization-tips">
        ...
        ${performanceMonitor_1.globalMonitor.getOptimizationSuggestions().length > 0 ?
            performanceMonitor_1.globalMonitor.getOptimizationSuggestions()
...
exports.analyticsPanel = new AnalyticsPanel();
