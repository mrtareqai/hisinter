...
exports.ExecutionStreamPanel = void 0;
const vscode = __importStar(require("vscode"));
const executionStreamManager_1 = require("../runtime/executionStreamManager");
class ExecutionStreamPanel {
    context;
    panel;
    disposables = [];
    streamManager;
    ...
    events = [];
    eventUnsubscribe;
    constructor(context, streamManager, options = {}) {
    ...
    onEvent(event) {
        ...
        if (event.type === executionStreamManager_1.ExecutionEventType.PHASE_START) {
     ...
     */
    setupPanel(options = {}) {
        this.panel = vscode.window.createWebviewPanel('executionStream', options.title || 'Sinter AI - Execution Stream', options.position || vscode.ViewColumn.Two, {
            enableScripts: true,
    ...
    updateUI() {
        ...
        const icon = phaseIcons[this.currentPhase] || '•';
...
exports.ExecutionStreamPanel = ExecutionStreamPanel;
//# sourceMappingURL=executionStreamPanel.js.map