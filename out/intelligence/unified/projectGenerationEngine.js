...
exports.ProjectGenerationEngine = void 0;
...
class ProjectGenerationEngine {
    ...
    async generateProject(request) {
        ...
        try {
            ...
            const projectPath = path_1.default.join(this.projectRoot, request.projectName);
            if (!fs_1.default.existsSync(projectPath)) {
                fs_1.default.mkdirSync(projectPath, { recursive: true });
            }
            // Generate structure
            for (const item of template.structure) {
                const fullPath = path_1.default.join(projectPath, item.path);
                    ...
                    if (item.template && item.path.includes('package.json')) {
                        content = JSON.stringify({
                            ...
                            dependencies: template.dependencies.length > 0
                                ? Object.fromEntries(template.dependencies.map((dep) => [dep, '^1.0.0']))
                                : undefined,
                        }, null, 2);
                    }
...
exports.ProjectGenerationEngine = ProjectGenerationEngine;
exports.default = ProjectGenerationEngine;
//# sourceMappingURL=projectGenerationEngine.js.map