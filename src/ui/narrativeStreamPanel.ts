...
import { NarrativeEvent, AgentState } from '../types/agent';

export class NarrativeStreamPanel {
  ...
  private exportEvents(): void {
    ...
    vscode.workspace.fs.writeFile(
      vscode.Uri.file(`${process.env.HOME}/.sinter/execution-log-${Date.now()}.txt`),
      Buffer.from(content)
    );
...
export const createNarrativeStreamPanel = (context: vscode.ExtensionContext): NarrativeStreamPanel => {
